...
app.config['MAIL_USERNAME'] = 'anonymouslookingirl@gmail.com' #os.environ.get('MAIL_USERNAME','1234') 
app.config['FLASK_ENV'] = 'development'
app.config['MAIL_PASSWORD'] = 'merapassformera1234!' #os.environ.get('MAIL_PASSWORD','1234')
